...
<section class="max-w-5xl mx-auto px-4 pt-6 pb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="p-6 md:p-8 flex flex-col justify-center">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="https://www.change.org/p/pour-le-maintien-de-la-séraphothèque-au-cœur-du-rozier-48150" target="_blank" class="inline-block bg-white text-emerald-700 border border-emerald-300 px-4 py-2 rounded-md text-sm font-medium hover:bg-emerald-50 transition">
                        Signer la pétition
                    </a>
                </div>
            </div>
...
<section class="max-w-3xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Actualités du village</h1>
            <p class="text-slate-500 text-sm mt-1">Les dernières publications de la commune.</p>
        </div>
    </div>
...
<section class="max-w-3xl mx-auto px-4 pb-10">
    <div class="mt-6 p-6 bg-slate-900 rounded-lg text-white text-center">
