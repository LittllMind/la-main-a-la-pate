                        ...
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                @match($log->event_type)
                                    @case('login') bg-emerald-100 text-emerald-800 @break
                                    @case('logout') bg-slate-100 text-slate-800 @break
                                    @case('create') bg-blue-100 text-blue-800 @break
                                    @case('update') bg-amber-100 text-amber-800 @break
                                    @case('delete') bg-red-100 text-red-800 @break
                                    @case('publish') bg-purple-100 text-purple-800 @break
