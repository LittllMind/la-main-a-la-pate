...
class PostSeeder extends Seeder
{
    ...
    {
        $categories = Category::limit(4)->get()->keyBy('id');
        $fallbackId = Category::value('id') ?: 1;

        $posts = [
            [
                'title' => 'Marché du Rozier ce dimanche',
                'slug' => 'marche-du-rozier-ce-dimanche',
                'category_id' => $categories->get(1)?->id ?? $fallbackId,
            ...
            [
                ...
                'category_id' => $categories->get(4)?->id ?? $fallbackId,
            ...
            [
                ...
                'category_id' => $categories->get(2)?->id ?? $fallbackId,
            ...
            [
                ...
                'category_id' => $categories->get(5)?->id ?? $fallbackId,
